        ...
        <div class="container mt-5">
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center">
                    <h1 class="display-4 mb-3">Alta Shift</h1>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-lg-7">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header">
                                    <h3 class="text-center font-weight-light my-4">Registe Shift</h3>
                                </div>
                                <div class="card-body"> <!--! Create a Servlet -->
                                    <form action="SvShift" method="POST">
                                        <div class="col-10">
                                            <%--                                            <div class="col-md-6">--%>
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputAfeccion" name="affecion" type="text"
                                                       placeholder="Enter Afeccion" required/>
                                                <label for="inputAfeccion">Afeccion</label>
                                            </div>


                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputDate" name="date"
                                                       type="date" placeholder="Enter The Date" required/>
                                                <label for="inputDate">Date</label>
                                            </div>

                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputHour" name="hour"
                                                       type="text" placeholder="Enter your shift schedule" required/>
